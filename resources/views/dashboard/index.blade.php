    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                <li class="media">
                <img class="img-fluid mt-1 img-shadow" src="/vendors/flag-icon-css/flags/4x3/id.svg" alt="image" width="40">
                ...
                <li class="media">
                <img class="img-fluid mt-1 img-shadow" src="/vendors/flag-icon-css/flags/4x3/my.svg" alt="image" width="40">
                <div class="media-body ml-3">
                ...
                <li class="media">
                <img class="img-fluid mt-1 img-shadow" src="/vendors/flag-icon-css/flags/4x3/us.svg" alt="image" width="40">
                <div class="media-body ml-3">
            ...
            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                ...
                <li class="media">
                <img class="img-fluid mt-1 img-shadow" src="/vendors/flag-icon-css/flags/4x3/ps.svg" alt="image" width="40">
                <div class="media-body ml-3">
                ...
                <li class="media">
                <img class="img-fluid mt-1 img-shadow" src="/vendors/flag-icon-css/flags/4x3/de.svg" alt="image" width="40">
                <div class="media-body ml-3">
