...
<link rel="stylesheet" href="../vendors/datatables.net-select-bs4/css/select.bootstrap4.min.css">
<!-- JS Libraies -->
<script src="../vendors/datatables/media/js/jquery.dataTables.min.js"></script>
<script src="../vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="../vendors/datatables.net-select-bs4/js/select.bootstrap4.min.js"></script>
